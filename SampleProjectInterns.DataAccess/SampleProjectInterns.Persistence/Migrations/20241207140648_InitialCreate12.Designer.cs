...
namespace SampleProjectInterns.Persistence.Migrations
{
    ...
    [Migration("20241207140648_InitialCreate12")]
            ...
            modelBuilder.Entity("SampleProjectInterns.Entities.KategoriRestoran", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("KategoriRestoranId"));

                    b.Property<string>("Ad")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasKey("KategoriRestoranId");

                    b.ToTable("KategoriRestoranlar");
                });
