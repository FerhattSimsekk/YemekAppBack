...
{
	public record GetRestoransQuery() : IRequest<List<RestoranDto>>;

	public class GetcRestoranQueryHandler : IRequestHandler<GetRestoransQuery, List<RestoranDto>>
	{
		private readonly IWebDbContext _webDbContext;
		private readonly IPrincipal _principal;

		public GetcRestoranQueryHandler(IWebDbContext webDbContext, IPrincipal principal)
		{
			_webDbContext = webDbContext;
			_principal = principal;
		}

		public async Task<List<RestoranDto>> Handle(GetRestoransQuery request, CancellationToken cancellationToken)
		{
